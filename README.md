To test the code, run a local webserver. You’ll need to do this from the command line from directory that contains your HTML file. With Python3, run "python -m http.server".
